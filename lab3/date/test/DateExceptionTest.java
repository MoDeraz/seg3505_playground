...
public class DateExceptionTest {
	...
	public static List<Integer[]> data(){
		...
		//code ajouté pour le labo
		params.add(new Integer[] {2017,	05,	35,	0,0,0});
		params.add(new Integer[] {2018,	05,	32,	0,0,0});
		params.add(new Integer[] {2021,	02,	30,	0,0,0});
		params.add(new Integer[] {1901,	00,	30,	0,0,0});		
		return params;
	}
