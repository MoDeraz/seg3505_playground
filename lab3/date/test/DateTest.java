...
class DateTest {
  ...
  // test ajouter pour le labo


  @Test
    void toString_valid(){
        Date date = new Date(2021, 7, 20);
        assertEquals("2020/July/20", date.toString());
    }

    @Test
    void nextDate_with9MonthAnd29Day() {
      Date today = new Date(1600, 8, 29);
      Date expectedTomorrow = new Date(1600, 8, 30);
      assertEquals(expectedTomorrow, today.nextDate());
  }

  @Test
    void nextDate_leapYearAnd29day() {
      Date today = new Date(1720, 2, 29);
      Date expectedTomorrow = new Date(1720, 3, 1);
      assertEquals(expectedTomorrow, today.nextDate());
  }
  ...
  @Test
    void nextDate_notLeapYearAnd28day() {
      Date today = new Date(1919, 2, 27);
      Date expectedTomorrow = new Date(1919, 2, 28);
      assertEquals(expectedTomorrow, today.nextDate());
  }
  ...
  @Test
    void equals() {
      Date today = new Date(2014, 9, 1);
      Date alsoToday = new Date(2014, 9, 1);
